...
| ④ 주거 환경 조건 | `conditions` | enum 배열 (다중) | `IMMEDIATE_MOVE_IN`, `FEMALE_ONLY`, `PRIVATE_BATH`, `ENGLISH_AVAILABLE`, `RESIDENT_REGISTRATION`, `NO_MAINTENANCE_FEE`, `MEALS_PROVIDED`, `DOUBLE_ROOM` | 선택(0개 허용), **최대 3개**, 중복 불가 |
